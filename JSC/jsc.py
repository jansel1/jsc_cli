...
help_messages = {
    ...
    "ski": "Usage: ski <hostname> [-h]\nDisplays IP or hostname information. Use -h to display hostname.",
    "test": "Usage: test\nRuns a test command.",
    "/hi": "Usage: /hi\nGreets the user.",
    ...
    "fort": "Usage: fort <file_path> <sort_type>\nSorts file content. Sort types: -dupes, -reverse.\t-dupes: Removes duplicate lines.\t-reverse: Reverses the file lines.",
    "broot": "Usage: broot <extra_tags> <amount>\nGenerates password lists with variations.",
    "xy": "Usage: xy <X> <Y>\nSets terminal window size to X columns and Y rows.",
    ...
    "crypt": "Usage: crypt <file_path> <password> [-e] [-text] [-passlist]\nEncrypts or decrypts the given file. Use -e to encrypt, -text for text mode, -passlist to use password list.",
